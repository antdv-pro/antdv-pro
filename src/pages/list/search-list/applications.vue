...
import { EditOutlined, EllipsisOutlined, SettingOutlined, ShareAltOutlined } from '@antdv-next/icons'
import Category from './components/category.vue'

const actionMenuItems = [
  { key: 'action-1', label: '1st menu item' },
  { key: 'action-2', label: '2nd menu item' },
  { key: 'action-3', label: '3rd menu item' },
]
...
const list = [
  {
    ...
    updatedAt: 1693313381539,
    createdAt: 1693313381539,
  ...
  },
  {
    ...
    href: 'https://ant.design',
    updatedAt: 1693306181539,
    createdAt: 1693306181539,
  ...
  },
  {
    ...
    href: 'https://ant.design',
    updatedAt: 1693291781539,
    createdAt: 1693291781539,
  ...
  },
  {
    ...
    href: 'https://ant.design',
    updatedAt: 1693284581539,
    createdAt: 1693284581539,
  ...
  },
  {
    ...
    href: 'https://ant.design',
    updatedAt: 1693277381539,
    createdAt: 1693277381539,
    subDescription: '那是一种内在的东西， 他们到达不了，也无法触及的',
    description: '在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。',
    activeUser: 136674,
    newUser: 1841,
  ...
  },
  {
    ...
    href: 'https://ant.design',
    updatedAt: 1693270181539,
    createdAt: 1693270181539,
    subDescription: '希望是一个好东西，也许是最好的，好东西是不会消亡的',
    description: '在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的组件会被抽离成一套标准规范。',
    activeUser: 122858,
    newUser: 1594,
...
<template>
  <div>
    <Category />
    <div class="mt-4 grid gap-16px grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4">
      <div v-for="item in list" :key="item.id" style="padding: 0">
        <a-card hoverable>
